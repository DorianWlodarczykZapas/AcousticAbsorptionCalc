...
class AcousticCalculationViewTests(TestCase):
    ...
    def test_unknown_materials_are_handled(self):
        norm = NormFactory()
        payload = {
            "height": 2.5,
            "length": 4.0,
            "width": 3.0,
            "furnishing": {"unicorn_skin": 1.0},
            "construction": {"dragon_bone": 2.0},
            "norm_id": norm.id,
            "frequency": "500",
        }
    ...
    def test_none_furnishing_and_construction_are_treated_as_empty(self):
        norm = NormFactory()
        payload = {
            "height": 2.5,
            "length": 5.0,
